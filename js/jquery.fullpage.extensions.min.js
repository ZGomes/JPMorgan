...
!function (e, n) {
    ...
    var r = "fullpage-wrapper", a = "." + r, l = "fp-scrollable", s = "." + l, c = "fp-responsive",
        ...
        M = "#" + L, O = "fp-tooltip", E = "." + O, R = "fp-show-active", H = ".slide", z = "fp-slide", B = "." + z,
        D = B + v, P = "fp-slides", F = "." + P, V = "fp-slidesContainer", W = "." + V, j = "fp-table",
        Z = "fp-slidesNav", Y = "." + Z, N = Y + " a", q = "fp-controlArrow", U = "." + q, G = "fp-prev", X = "." + G,
        Q = q + " " + G, _ = U + X, K = "fp-next", J = "." + K, $ = q + " " + K, ee = U + J, ne = e(n), te = e(t),
        oe = {
            scrollbars: !0,
            mouseWheel: !0,
            hideScrollbars: !1,
    ...
    e.fn.fullpage = function (l) {
        ...
        function ze() {
            var e = n.location.hash.replace("#", "").split("/"), t = Nn(decodeURIComponent(e[0]));
        ...
        function De() {
            ...
            if ((!l.autoScrolling || l.scrollBar || vt("dragAndMove")) && !St()) {
                var i = vt("dragAndMove") ? o.abs(At.dragAndMove.getCurrentScroll()) : ne.scrollTop(), r = (Fe(i), 0),
                    a = i + ne.height() / 2,
                    s = vt("dragAndMove") ? At.dragAndMove.getDocumentHeight() : Ct.height() - ne.height(), c = s === i,
                ...
                if (n = e(d).eq(r), !n.hasClass(p)) {
                    Qt = !0;
                    var h, v, g = e(b), m = g.index(y) + 1, S = Fn(n), w = n.data("anchor"), x = n.index(y) + 1,
                        C = n.find(D);
        ...
        function je(n) {
            ...
            if (!Ze(n.target) && Ye(t)) {
                ...
                var r = l.scrollOverflowHandler.scrollable(i), a = lt(t);
        ...
        function Ue(t) {
            ...
            if (l.autoScrolling && !kt && !r) {
                ...
                var f = e(b), u = l.scrollOverflowHandler.scrollable(f), h = i - no;
                if (no = i, h > 200 && (Pt = []), Dt && !mt()) {
                    var p = qe(Pt, 10), v = qe(Pt, 70), g = p >= v;
        ...
        function Qe(e) {
            var n = e.position(), t = n.top,
                ...
                i = t - Ht + e.outerHeight(), r = l.bigSectionsDestination;
        ...
        function fn(e) {
            var n = dn(), t = ["localhost", "127.0.0.1", "jshell.net", "UDdDQU5ZNlNN"], o = t[0], i = t[1], r = t[2],
                a = cn(t[3]), l = [o, i, r].indexOf(n) < 0 && 0 !== n.length,
        ...
        function pn() {
            if (!Qt && !l.lockAnchors) {
                var e = n.location.hash.replace("#", "").split("/"), t = decodeURIComponent(e[0]),
                    o = decodeURIComponent(e[1]), i = "undefined" == typeof Tt,
        ...
        function jn(e) {
            e.hasClass(j) || e.addClass(j).wrapInner('<div class="' + A + '" css="height:' + Zn(e) + 'px;" />')
        }
        ...
        function Jn() {
            var n = e(b), t = n.find(D), o = Kn(n), i = Kn(t), r = String(o);
        ...
        var xt = e("html, body"), Ct = e("body"), At = e.fn.fullpage;
        l = e.extend(!0, {
            menu: !1,
            anchors: [],
            lockAnchors: !1,
        ...
        var Tt, It, kt, Lt, Mt = !1,
            ...
            Et = "ontouchstart" in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, Rt = e(this),
            Ht = ne.height(), zt = !1, Bt = !0, Dt = !0, Pt = [], Ft = {};
        Ft.m = {up: !0, down: !0, left: !0, right: !0}, Ft.k = e.extend(!0, {}, Ft.m);
